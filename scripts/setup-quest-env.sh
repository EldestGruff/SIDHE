#!/bin/bash
# File: scripts/setup-quest-env.sh
# Description: Set up environment for Quest implementation

echo "🔧 SIDHE Quest Environment Setup"
echo "=================================="
echo ""
...
# Check if we're in the sidhe directory
if [ ! -f "THE_OLD_LAWS.md" ]; then
    echo "❌ Not in SIDHE repository root"
...
if [ -z "$GITHUB_REPO" ]; then
    ...
    echo "  Setting default: EldestGruff/sidhe"

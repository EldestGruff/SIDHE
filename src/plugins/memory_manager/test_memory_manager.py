...
def test_store_and_retrieve():
    ...
    with patch('redis.from_url', return_value=mock_redis):
        ...
        mock_redis.get.assert_called_once_with("riker:memory:test-conv-1")
...
def test_memory_expiration():
    ...
    with patch('redis.from_url', return_value=mock_redis):
        ...
        # Verify Redis calls
        mock_redis.exists.assert_called_once_with("riker:memory:test-conv-1")
...
def test_clear_memory():
    ...
    with patch('redis.from_url', return_value=mock_redis):
        ...
        # Verify Redis calls
        mock_redis.delete.assert_called_once_with("riker:memory:test-conv-1")

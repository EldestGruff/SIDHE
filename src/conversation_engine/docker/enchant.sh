...
# Orchestrates complete Docker enchantment with validation
#
...
print_header() {
    echo -e "${BLUE}"
    echo "🚀 SIDHE CONVERSATION ENGINE DEPLOYMENT"
    echo "========================================"
    echo -e "${NC}"
}
...
cleanup_existing() {
    log_info "Cleaning up existing enchantment..."
...
run_validation() {
    log_info "Running enchantment validation..."
...
# Main enchantment function
enchant() {
    print_header
    
    local start_time=$(date +%s)
    
    # Run enchantment steps
    check_prerequisites
    cleanup_existing
    build_images
    start_services
...
case "${1:-enchant}" in
    ...
    "stop")
        ...
        ;;
    "clean")
        log_info "Cleaning up enchantment..."
    ...
    "help")
        ...
        echo ""
        echo "Commands:"
        echo "  enchant    - Full enchantment (default)"
